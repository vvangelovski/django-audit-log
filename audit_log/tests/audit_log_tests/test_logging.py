...
class LogEntryMetaOptionsTest(TestCase):
    ...
    def test_table_name(self):
        ...
        self.failUnlessEqual(WarehouseEntry.audit_log.model._meta.db_table,
...
class TrackingChangesTest(TestCase):
    ...
    def run_client(self, client):
        ...
        client.post('/product/create/', {'name': 'Test Product', 'description': 'Test description', 'price': '2.22',
                                         'category': 'Test Category'})
        client.post('/product/update/1/',
                    {'name': 'Test Product', 'description': 'Test description new', 'price': '5.00',
                     'category': 'Test Category'})
